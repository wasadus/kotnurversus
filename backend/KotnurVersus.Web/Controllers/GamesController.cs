...
public class GamesController : CreatableEntityControllerBase<Game, GameCreationArgs, InvalidGameDataReason, GameSearchRequest>
{
    ...
    public async Task<VoidActionResult<ErrorInfo<AccessMultipleEntitiesError>>> DeleteAllRounds(
        [FromServices] IDeleteAllRoundsInGameCommand command, 
        [FromRoute] Guid id)
    {
    ...
    public async Task<ActionResult<Game, ErrorInfo<InvalidGameDataReason>>> StartTournament(
        [FromServices] IStartGameCommand command,
        [FromRoute] Guid id, 
